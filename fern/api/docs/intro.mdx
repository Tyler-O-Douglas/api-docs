...
After you make a request to the [/lcf](https://docs.meetstring/api-reference/lcf) endpoint,
...
by your application and mapped to the appropriate values for the selected carrier.  Please refer to the [LCF endpoint documentation](https://docs.meetstring/api-reference/lcf)
